...
async function handler(req, res) {
    ...
    if (dataSetType == _types_dataset__WEBPACK_IMPORTED_MODULE_0__/* .DataSetType.QUESTION */ .I.QUESTION) {
        result = await utils_serverRequest__WEBPACK_IMPORTED_MODULE_1__/* ["default"]["delete"] */ .Z["delete"](`/question/${id}`);
    } else {
        result = await utils_serverRequest__WEBPACK_IMPORTED_MODULE_1__/* ["default"]["delete"] */ .Z["delete"](`/document/${id}`);
    }
...
var __webpack_exports__ = (__webpack_exec__(7258));
