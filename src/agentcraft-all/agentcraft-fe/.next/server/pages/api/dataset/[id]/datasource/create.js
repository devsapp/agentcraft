...
async function handler(req, res) {
    ...
    if (dataSetType == _types_dataset__WEBPACK_IMPORTED_MODULE_1__/* .DataSetType.QUESTION */ .I.QUESTION) {
        result = await utils_serverRequest__WEBPACK_IMPORTED_MODULE_0__/* ["default"].post */ .Z.post("/question/add", payload);
    } else {
        result = await utils_serverRequest__WEBPACK_IMPORTED_MODULE_0__/* ["default"].post */ .Z.post("/document/add", payload);
    }
