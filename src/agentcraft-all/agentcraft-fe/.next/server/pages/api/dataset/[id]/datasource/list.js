...
/* harmony import */ var _types_dataset__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(1085);
...
async function handler(req, res) {
    ...
    if (dataSetType == _types_dataset__WEBPACK_IMPORTED_MODULE_1__/* .DataSetType.QUESTION */ .I.QUESTION) {
        result = await utils_serverRequest__WEBPACK_IMPORTED_MODULE_0__/* ["default"].get */ .Z.get(`/question/list/${id}`, {
            params: {
                page,
                limit
            }
        ...
        result = await utils_serverRequest__WEBPACK_IMPORTED_MODULE_0__/* ["default"].get */ .Z.get(`/document/list/${id}`, {
            params: {
                page,
                limit
            }
...
var __webpack_exports__ = (__webpack_exec__(4811));
