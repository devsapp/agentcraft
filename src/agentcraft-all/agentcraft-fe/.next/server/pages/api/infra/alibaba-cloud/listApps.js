...
/* harmony import */ var constants_index__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(6764);
...
async function handler(req, res) {
    ...
    try {
        ...
        data.data = agentCraftAppList.filter((item)=>item.name.indexOf(constants_index__WEBPACK_IMPORTED_MODULE_1__/* .AGENTCRAFT_APP */ .Ad) === 0);
    } catch (e) {
        status = 500;
        data.code = status;
...
var __webpack_exports__ = __webpack_require__.X(0, [7332,6764], () => (__webpack_exec__(7473)));
