...
/* harmony import */ var querystring__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(9819);
...
async function handler(req, res) {
    ...
    const result = await utils_serverRequest__WEBPACK_IMPORTED_MODULE_0__/* ["default"].post */ .Z.post("/auth/login", querystring__WEBPACK_IMPORTED_MODULE_1___default().stringify({
        username,
        password,
        scope: "",
        client_id: "",
