...
function KnowledgeBaseForm({ appId , containerType  }) {
    ...
    const form = (0,_mantine_form__WEBPACK_IMPORTED_MODULE_4__.useForm)({
        initialValues: {
            name: "",
            description: "",
            prompt_template: constants_index__WEBPACK_IMPORTED_MODULE_12__/* .PROMPT_TEMPLATE */ .Gf,
            ...
            model_ip_limit: 0,
            llm_history_len: 0,
            system_message: constants_index__WEBPACK_IMPORTED_MODULE_12__/* .DEFAULT_SYSTEM_PROMPT */ .cl,
...
function List({ appId  }) {
    ...
    const rows = knowledgeBaseList.map((element)=>/*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("tr", {
            children: [
                ...
                /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("td", {
                    children: (0,utils_index__WEBPACK_IMPORTED_MODULE_13__/* .formatDateTime */ .o0)(element.created)
                }),
...
var __webpack_exports__ = __webpack_require__.X(0, [1664,6766,3658,372,4350,4082,2788,7511,2041], () => (__webpack_exec__(3905)));
