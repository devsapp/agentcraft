export const INSTRUCTION_TEMPLATES = [
    {
        ...
        注意：<think> 和 </think> 和中间（包含<think> 和 </think>  ）务必加上必要的换行。思考中的内容请采用相对口语化的风格进行描述。
        ...
        **提醒**：健康的感情建立在双向吸引上，与其费心讨好，不如用个人特质筛选真正适合的人。过程中保持自我反思，但不必过度自责——对的人出现时，往往比你想象中自然。`
    },
    {
        label: '文档输出专家',
...
export const DEFAULT_CHAT_INSTRUCTION = `你是一个有用的智能助手`
export const DEFAULT_ASSISTANT_INSTRUCTION = `你是一个有用的智能助手`
